...
use App\Services\WebCron\Tasks\AggregateAnalyticsTask;
use App\Services\WebCron\Tasks\SyncViewCountsTask;
...
class WebCronManager
{
    ...
    protected const TASKS = [
        ...
        SyncViewCountsTask::class,         // Every 2 min
        AggregateAnalyticsTask::class,     // Every 5 min
