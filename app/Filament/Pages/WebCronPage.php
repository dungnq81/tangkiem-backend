...
class WebCronPage extends Page implements HasForms
{
    ...
    {
        $this->form->fill([
            'web_cron_enabled'    => WebCronService::isEnabled(),
            'web_cron_background' => WebCronService::isBackgroundEnabled(),
            'web_cron_interval'   => (string) WebCronService::getInterval(),
        ]);
    }
    ...
    {
        try {
            $log = WebCronService::runManually();
    ...
    {
        return [
            'status' => WebCronService::getStatus(),
            'logs'   => WebCronService::getRecentLogs(30),
        ];
    }
    ...
    {
        return WebCronService::isEnabled() ? 'ON' : 'OFF';
    }
    ...
    {
        return WebCronService::isEnabled() ? 'success' : 'gray';
    }
}
