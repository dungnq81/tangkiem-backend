                ...
                TextEntry::make('author_statistics')
                    ...
                    ->state(function (?Author $record): HtmlString {
                        ...
                        return StatCard::grid([
                            [
                                StatCard::item('Số truyện', $record->stories()->count(), '📚', 'blue'),
                                StatCard::item('Tổng lượt xem', (int) $record->stories()->sum('view_count'), '👁️', 'green'),
                                StatCard::item('Tổng số chương', (int) $record->stories()->sum('total_chapters'), '📖', 'cyan'),
                            ],
                        ]);
                    })
                    ->columnSpanFull(),
