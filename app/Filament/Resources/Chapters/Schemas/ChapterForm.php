    ...
    private static function storyAndNumberSection(): Section
    {
        return Section::make('Truyện & Số chương')
            ->schema([
                ...
                TextEntry::make('story_label')
                    ->label('Truyện')
                    ->state(fn (?Chapter $record): ?HtmlString => $record?->story
                        ? new HtmlString(
        ...
        return Section::make('Thống kê chương')
            ...
            ->schema([
                TextEntry::make('statistics_display')
                    ->hiddenLabel()
                    ->state(function (?Chapter $record): HtmlString {
                        if (! $record) {
                        ...
                        return StatCard::grid([
                            [
                                ...
                                StatCard::item('Số từ', $record->word_count, '✏️', 'cyan'),
                            ],
                        ]);
                    })
                    ->columnSpanFull(),
