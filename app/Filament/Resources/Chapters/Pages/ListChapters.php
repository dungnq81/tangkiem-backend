...
class ListChapters extends ListRecords
{
    ...
    public function getTabs(): array
    {
        $tabs = [
            'all' => Tab::make('Tất cả')
                ...
                ->modifyQueryUsing(function (Builder $query) {
                    // Require story filter on the "All" tab to avoid loading 50k chapters.
                    // Story-specific tabs bypass this since they directly filter by story_id.
                    $storyFilter = $this->tableFilters['story_id']['value'] ?? null;
        ...
        // 5 most recently updated stories — quick shortcuts with chapter count
