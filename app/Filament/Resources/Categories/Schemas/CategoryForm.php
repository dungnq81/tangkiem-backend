...
class CategoryForm
{
    ...
    private static function descriptionTextarea(): Textarea
    {
        return Textarea::make('description')
            ...
            ->rows(3)
            ->columnSpanFull()
            ->helperText(new HtmlString('<span class="text-xs">Mô tả ngắn về thể loại (tối đa 500 ký tự)</span>'));
    }
    ...
    private static function contentEditor(): RichEditor
    {
        return RichEditor::make('content')
            ...
            ->helperText(new HtmlString('<span class="text-xs">Nội dung chi tiết về thể loại (hiển thị trên trang thể loại)</span>'));
    }
