                ...
                Section::make('API Keys')
                    ->schema([
                        TextInput::make('public_key')
                            ...
                            ->disabled()
                            ->dehydrated(false)
                            ->helperText(new HtmlString('<span class="text-xs">Dùng cho client-side, xác thực bằng Origin header</span>')),
                        ...
                        TextInput::make('secret_key')
                            ...
                            ->password()
                            ->revealable()
                            ->helperText(new HtmlString('<span class="text-xs">Dùng cho server-to-server, lưu trong <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded">.env</code></span>')),
                    ])
                    ->columns(2)
                    ->visibleOn('edit'),
