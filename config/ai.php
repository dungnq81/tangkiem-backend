...
return [
    ...
    'providers' => [
        ...
        */
        'cerebras' => [
            ...
            'models'        => [
                // ── Production Models ────────
                'llama3.1-8b'                    => 'Llama 3.1 8B',              // ~2200 tok/s
                'llama-3.3-70b'                  => 'Llama 3.3 70B',             // ~2400 tok/s
                'gpt-oss-120b'                   => 'GPT-OSS 120B',              // ~3000 tok/s
                'qwen-3-32b'                     => 'Qwen 3 32B',                // ~2000 tok/s
                'zai-glm-4.7'                    => 'GLM 4.7',                   // ~1000 tok/s, 355B params

                // ── Preview Models ────────
                'qwen-3-235b-a22b-instruct-2507' => 'Qwen 3 235B Instruct (preview)',  // ~1400 tok/s
                'qwen-3-235b-thinking'           => 'Qwen 3 235B Thinking (preview)',  // reasoning mode
            ],
        ],
        ...
        */
        'openai' => [
            ...
            'models'        => [
                ...
                'gpt-5'           => 'GPT-5',                    // Base GPT-5, multimodal
                'gpt-5-mini'      => 'GPT-5 Mini',               // Lightweight, low-latency
        ...
        */
        'grok' => [
            ...
            'models'        => [
                // ── Grok 4.x ────────
                'grok-4.20-beta'                 => 'Grok 4.20 Beta',                  // Newest flagship, agentic tool-calling
                'grok-4'                         => 'Grok 4',                           // Reasoning model, 256K context
                'grok-4.1-fast'                  => 'Grok 4.1 Fast',                    // $0.20/M input, 2M context
                'grok-4-1-fast-non-reasoning'    => 'Grok 4.1 Fast (non-reasoning)',
                'grok-code-fast-1'               => 'Grok Code Fast 1',                 // Code-specialized, $0.20/M input
        ...
        */
        'blackbox' => [
            ...
            'models'        => [
                ...
                'gpt-5.2'                => 'GPT-5.2 (via Blackbox)',
                'claude-opus-4-6'        => 'Claude Opus 4.6 (via Blackbox)',
                'gemini-3'               => 'Gemini 3 (via Blackbox)',
                'grok-4'                 => 'Grok 4 (via Blackbox)',
        ...
        /*
        |----------------------------------------------------------------------
        | AI Magicx — Aggregator platform (trả phí, credit-based)
        |----------------------------------------------------------------------
        | Routes to OpenAI, Anthropic, Google models via unified API.
        | Format: Custom (NOT OpenAI-compatible) — /chat endpoint, `message` field
        | Best for: truy cập nhiều model qua 1 API key duy nhất
        |
        | Docs: https://docs.aimagicx.com/api/chat
        */
        'aimagicx' => [
            'api_key'       => env('AIMAGICX_API_KEY'),
            'base_url'      => 'https://beta.aimagicx.com/api/v1',
            'api_format'    => 'aimagicx',
            'default_model' => '4o-mini',
            'models'        => [
                // ── OpenAI via AI Magicx ────
                'gpt-5.1'          => 'GPT-5.1 (via AI Magicx)',
                '4o'               => 'GPT-4o (via AI Magicx)',
                '4o-mini'          => 'GPT-4o Mini (via AI Magicx)',
                'gpt-4.1'          => 'GPT-4.1 (via AI Magicx)',
                'gpt-4.1-mini'     => 'GPT-4.1 Mini (via AI Magicx)',
                'o3'               => 'o3 (via AI Magicx)',
                'o3-mini'          => 'o3 Mini (via AI Magicx)',
                'o4-mini'          => 'o4-mini (via AI Magicx)',

                // ── Anthropic via AI Magicx ────
                'claude-opus-4.6'   => 'Claude Opus 4.6 (via AI Magicx)',
                'claude-opus-4.5'   => 'Claude Opus 4.5 (via AI Magicx)',
                'claude-sonnet-4'   => 'Claude Sonnet 4 (via AI Magicx)',
                'claude-3-5-sonnet' => 'Claude 3.5 Sonnet (via AI Magicx)',

                // ── Google via AI Magicx ────
                'gemini-3.1-pro'   => 'Gemini 3.1 Pro (via AI Magicx)',
                'gemini-2.5-flash' => 'Gemini 2.5 Flash (via AI Magicx)',
                'gemini-2.5-pro'   => 'Gemini 2.5 Pro (via AI Magicx)',

                // ── Other via AI Magicx ────
                'grok-4.20'        => 'Grok 4.20 (via AI Magicx)',
                'llama-4-maverick' => 'Llama 4 Maverick (via AI Magicx)',
                'mistral'          => 'Mistral (via AI Magicx)',
            ],
        ],
    ],
    ...
    */
    ...
    'imagen' => [
        /*
        |----------------------------------------------------------------------
        | Primary: Imagen Predict API (dedicated image generation endpoint)
        |----------------------------------------------------------------------
        | Uses :predict endpoint — purpose-built, more reliable than :generateContent.
        | Requires billing enabled on Google AI Studio.
        | Set to null to skip Imagen Predict and use GenerateContent directly.
        |
        | Supported models: imagen-4.0-generate-001, imagen-3.0-generate-002
        */
        'predict_model' => env('IMAGEN_PREDICT_MODEL', 'imagen-4.0-generate-001'),

        /*
        |----------------------------------------------------------------------
        | Fallback: Gemini GenerateContent with responseModalities: ['Image']
        |----------------------------------------------------------------------
        | Uses :generateContent endpoint — text-first, image is secondary.
        | Less reliable (may return text instead of image), but works on free tier.
        */
        ...
        'aspect_ratios' => [
            ...
            'avatar'    => '1:1',   // Ảnh đại diện tác giả
    ...
    */
    ...
    'features' => [
        'auto_summary'          => ['label' => 'Nội dung & SEO truyện',     'description' => 'Tạo nội dung giới thiệu + SEO cho truyện (composite, 1 API call)'],
        'auto_author_content'   => ['label' => 'Nội dung & SEO tác giả',   'description' => 'Tìm kiếm internet → tiểu sử, thông tin, mạng xã hội + SEO tác giả (composite, 1 API call)'],
        'auto_category_content' => ['label' => 'Nội dung & SEO thể loại',  'description' => 'Tạo mô tả, nội dung chi tiết + SEO cho thể loại (composite, 1 API call)'],
        'cover_generation'      => ['label' => 'Tạo ảnh AI',               'description' => 'Ảnh bìa truyện (2:3), avatar tác giả (1:1), ảnh thể loại (4:3)'],
        'content_clean'         => ['label' => 'Dọn dẹp nội dung chương',  'description' => 'Loại bỏ quảng cáo, watermark, text rác'],
        'content_moderation'    => ['label' => 'Kiểm duyệt bình luận',     'description' => 'Tự động ẩn bình luận spam, toxic, NSFW'],
    ],
